...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "sir_tp6@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "sir_tp6 API";

        private String description = "sir_tp6 API documentation";
